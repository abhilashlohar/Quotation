	...
	<div id="url_main">
		...
		<table width="100%">
			...
			<tr>
				...
				<br/><input type="text" class="span12 m-wrap" name="text2" placeholder="eg. Hotel name"></td>
			</tr>
		</table>
		</div>
	</div>
...
$(document).ready(function() {
	$('form').submit( function(ev){
		...
		type: 'POST',
			...
			$("#wait").hide();
			//alert(response);
			window.open("http://localhost/pdf/pdf_new.php?q="+response);
